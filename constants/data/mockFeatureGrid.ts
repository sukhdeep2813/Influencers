export const platformFeatures = [
  {
    ...
    title: "Smart search",
    description:
      "Filter by city, language, followers, engagement rate, audience data, and budget — not just hashtags.",
    icon: "◎",
  ...
  },
  {
    ...
    description:
      "Creators apply, CreatorLink builds the proposal — budget, deliverables, timeline.",
    icon: "◫",
  ...
  },
  {
    ...
    description:
      "Track pending, paid, and invoiced amounts in real time — from either side.",
    icon: "₹",
